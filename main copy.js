...
//comparePw() 이렇게 하면 그냥 실행이 되어 버린다. 함수 자체를 넣어놔야한다..?
...
function checkPw() {
  ...
  if (pw1.value === "") {
    ...
    error[1].innerHTML = '멋진 비밀번호네요. 잘봤습니다.'
    error[1].style.display = 'block'
...
function checkPhoneNum(){
  ...
  if(mobile.value == ''){
    ...
    error[7].innerHTML = '형식에 맞지않는 번호입니다.'
    error[7].style.display = 'block';
  }else{
